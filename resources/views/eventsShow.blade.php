<x-main-layout>
    <div class="m-2 p-2 flex justify-between">
        ...
        <div class="flex space-x-2">
            From:
            <span class="mx-2">{{ $event->start_date }}</span> | <span
                class="mx-2">{{ $event->end_date }}</span>
        </div>
    </div>
            ...
            <div class="flex flex-col">
                <div class="ripple relative overflow-hidden rounded-lg bg-cover bg-[50%] bg-no-repeat shadow-lg dark:shadow-black/20"
                    data-te-ripple-init data-te-ripple-color="light">
                        ...
                        <img src="{{ url('/')}}/uploads/{{$event->image }}" class="w-30" alt="Louvre" />
                        <a href="#!">
                            <div
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-semibold text-gray-400">{{ $comment->content }}</p>
                                            ...
                                            <form action="{{ route('events.comments.destroy', [$event->id, $comment->id]) }}"
                                                ...
                                                @method('DELETE')
                                                <button
                                                    class="text-white mt-6 rounded-lg bg-red-400 px-4 py-2 text-sm tracking-wider  outline-none hover:bg-red-300">Delete</button>
